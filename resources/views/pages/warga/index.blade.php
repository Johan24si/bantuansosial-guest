...
<div class="bg-dark p-4 rounded-4 shadow-lg">
    ...
    <div class="row g-4">
        @foreach($data as $w)
        <div class="col-md-4">
            <div class="card border-0 shadow-lg h-100 hover-zoom" style="transition:0.3s; border-radius:18px;">
                <div class="card-body p-4">
                    ...
                    <div class="d-flex gap-2">
                        <a href="{{ route('warga.edit', $w->warga_id) }}" class="btn btn-warning btn-sm w-50 shadow-sm">
    ...
    <div class="mt-4 d-flex justify-content-center">
        <nav aria-label="Page navigation">
            <ul class="pagination">
                ...
                @else
                    <li class="page-item">
                        <a class="page-link" href="{{ $data->appends(request()->query())->previousPageUrl() }}">«</a>
                    </li>
                @endif
                ...
                @if ($data->hasMorePages())
                    <li class="page-item">
                        <a class="page-link" href="{{ $data->appends(request()->query())->nextPageUrl() }}">»</a>
                    </li>
                @else
                    <li class="page-item disabled"><span class="page-link">»</span></li>
                @endif
