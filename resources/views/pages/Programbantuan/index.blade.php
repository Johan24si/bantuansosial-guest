        ...
        <div class="col-md-4">
            <div class="card border-0 shadow-lg h-100 hover-zoom" style="border-radius:18px; transition:0.3s;">
                <div class="card-body p-4">
                    ...
                    <div class="mb-3">
                        <p class="mb-1"><i class="bi bi-cash-stack me-1"></i> Rp{{ number_format($p->anggaran, 2, ',', '.') }}</p>
                        <p class="mb-0 text-muted"><i class="bi bi-card-text me-1"></i> {{ Str::limit($p->deskripsi, 60) }}</p>
                    </div>
                    ...
                    <div class="d-flex gap-2 mt-3">
                        ...
                        <form action="{{ route('program_bantuan.destroy', $p->program_id) }}" method="POST" class="w-50">
                            @csrf
                            @method('DELETE')
